...
<head>
    ...
    <title>Giriş Yap - <?php echo $config['logo'];?></title>
...
<body>
    <div class="talhacaba-auth-container">
        <div class="talhacaba-auth-card">
            <h2 class="talhacaba-auth-title">Giriş Yap</h2>
            <p class="talhacaba-auth-subtitle">Hesabınıza giriş yapmak için bilgilerinizi girin.</p>
            <form class="talhacaba-auth-form">
                ...
                <button type="submit" class="talhacaba-btn talhacaba-btn-primary talhacaba-btn-large">Giriş Yap</button>
            </form>
            <p style="margin-top: 1.5rem; color: #6b7280;">Hesabınız yok mu? <a href="kayit-ol.php" class="talhacaba-auth-link">Kayıt Olun</a></p>
        </div>
    </div>
</body>
</html>
